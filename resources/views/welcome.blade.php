...
<body class="antialiased">
    <div
            ...
            <div class="sm:fixed sm:top-0 sm:right-0 p-6 text-right">
                @auth
                    @if (auth()->user()->role == 'responsable')
                        <a href="{{ url('/responsable_dashboard') }}"
                            class="font-semibold text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500">Home</a>
                    @elseif (auth()->user()->role == 'stock')
                        <a href="{{ url('/stock/responsable') }}"
                            class="font-semibold text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500">Home</a>
                    @else
                        <a href="{{ url('/caissier_dashboard') }}"
                            class="font-semibold text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500">Home</a>
                    @endif
                @else
                    <a href="{{ route('login') }}"
        ...
        <div class="max-w-7xl mx-auto p-6 lg:p-8">
                            ...
                            <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
                                <div class="carousel-inner">
                                    <div class="carousel-item active">
                                        <img class="d-block w-100" src={{ asset('2.png') }}  alt="First slide">
                                    </div>
                                    <div class="carousel-item">
                                        <img class="d-block w-100" src={{ asset('3.png') }} alt="Second slide" />
                                    </div>
                                    <div class="carousel-item">
                                        <img class="d-block w-100" src={{ asset('4.png') }} alt="Third slide">
                                    </div>
                                </div>
            ...
            <div class="ml-4 text-center text-sm text-gray-500 dark:text-gray-400 sm:text-right sm:ml-0 mt-4">
                Tous droits résérvés © NASAMI 2023
            </div>
        </div>
    </div>
    </div>
